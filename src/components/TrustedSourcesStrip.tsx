const TrustedSourcesStrip = () => {
  ...
  return <section id="sources" className="py-12 bg-[#c90404] border-y border-primary-dark w-full">
      ...
      <div className="flex items-center gap-8">
        ...
        <div className="flex-1 relative overflow-hidden">
          <div className="news-ticker gap-12 items-center px-[24px]">
            ...
            {sources.map((source, index) => <div key={`third-${index}`} className="flex-shrink-0 text-xl font-bold text-primary-foreground/90 hover:text-primary-foreground transition-colors">
              {source}
            </div>)}
          </div>
        </div>
